...
from resources.books import UserReviewsResource, UserFavoritesResource
...
def create_routes():
    ...
    api.add_resource(UserReviewsResource, '/api/books')
    api.add_resource(UserFavoritesResource, '/api/user_book')
    api.add_resource(GetBookInformationResource, '/api/')
